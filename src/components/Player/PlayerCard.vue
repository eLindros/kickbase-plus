          ...
          <div class="flex flex-col align-start">
            ...
            <v-row class="justify-start ma-0" style="width: 100%">
              <v-col class="pa-0 mr-2">
                ...
                <v-row class="grey--text mt-0" style="font-size: xx-small"> Pkt. </v-row>
              </v-col>
              <v-col class="pa-0">
                <v-row class="text-body-2 font-weight-bold ma-0">
      ...
      >
        <v-expansion-panel>
          <v-expansion-panel-header class="elevation-0">
            <v-icon class="mr-2 player-card-accordion__icon" color="yellow darken-2"
              >fa-medal</v-icon
            >
        ...
        <v-expansion-panel v-if="showPurchaseStatistic">
          <v-expansion-panel-header class="elevation-0">
            <v-icon class="mr-2 player-card-accordion__icon" color="teal darken-2"
...
export default {
  ...
  computed: {
    ...
    getPricePerPointColor() {
      ...
      return this.getPricePerPoint < 200 && this.getPricePerPoint > 0 ? positive : negative
    },
    getPlayerStatistics() {
      return {
        headers: [
