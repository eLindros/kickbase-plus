<template>
  <div class="options-bar">
    <div v-if="mobileState === false" class="options-bar__mobile_content">
      <v-btn
        large
        fab
        color="secondary"
        class="options-bar__expand-btn elevation-15"
    ...
    <div
      ...
      :class="{
        'options-bar__expanded_content--active': mobileState,
        'elevation-15': mobileState,
      }"
    >
      <div class="options-bar__expanded_content__inner">
        <div class="options-bar__expanded_content__inner__content">
          ...
          <v-btn
            v-if="hasInfoSlot"
            class="mb-2 options-bar__info-button"
            text
            color="info"
          ...
          <div v-if="showInfo" class="options-bar__info_content">
            <slot name="info"></slot>
          </div>
        </div>
        ...
        <v-btn
          ...
          block
          x-large
          class="mt-5 kp-button elevation-0"
          @click="toggleMobileState"
          >close</v-btn
        >
      </div>
